...
CUTE_MATH2D_INLINE float len(v2 a) { return sqrtf(dot(a, a)); }
CUTE_MATH2D_INLINE float distance(v2 a, v2 b) { return sqrtf(powf((a.x - b.x), 2) + powf((a.y - b.y), 2)); }
CUTE_MATH2D_INLINE v2 norm(v2 a) { return a / len(a); }
CUTE_MATH2D_INLINE v2 safe_norm(v2 a) { float sq = dot(a, a); return sq ? a / sqrtf(sq) : v2(0, 0); }
